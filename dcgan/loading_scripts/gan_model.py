...
This is the model training script for HW A3:
- version of Pytorch used is the same as on HPC Prince
- implements a conditional DCGAN model with an embedding layer on the one-hot encoded class labels pass to the discriminator
