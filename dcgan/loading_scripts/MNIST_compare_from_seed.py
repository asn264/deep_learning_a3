...
vutils.save_image(fake.data, opt.outf+'MNIST_fixed_noise_vanilla_fake.png', normalize=True)
vutils.save_image(fake_conditional.data, opt.outf+'MNIST_fixed_noise_conditional_fake.png', normalize=True)
